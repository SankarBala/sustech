...
function About() {
    return (
        <div>
            <h2>About Us</h2>
            <p>
                Welcome to <span className="text-info">MOHAMMED SHIF UDDIN & SOBUJ TECHNICAL SERVICES</span>, your trusted partner for all your construction needs.

                At <span className="text-info">MOHAMMED SHIF UDDIN & SOBUJ TECHNICAL SERVICES</span>, we take pride in our expertise and commitment to delivering high-quality construction solutions. With years of experience in the industry, we have established ourselves as a leading construction company dedicated to excellence and customer satisfaction.
                ...
                Whether you have a residential dream home, a commercial development, or an infrastructure project in mind, trust <span className="text-info">MOHAMMED SHIF UDDIN & SOBUJ TECHNICAL SERVICES</span> to be your reliable partner. Contact us today to discuss your construction needs and let us bring your vision to reality.
            </p>
        </div>
    )
}
